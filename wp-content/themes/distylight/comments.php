...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation-comment" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'distylight' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'distylight' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'distylight' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'distylight' ); ?></p>
	<?php endif; ?>
